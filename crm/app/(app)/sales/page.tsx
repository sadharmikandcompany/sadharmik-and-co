    ...
    <div className="w-full">
      <SalesClient
        orders={orders.map((o) => ({
          ...
          customerIsMandir: o.customer.isMandir,
          customerMandirNumber: o.customer.mandirNumber,
          customerIsShop: o.customer.isShop,
          customerShopNumber: o.customer.shopNumber,
