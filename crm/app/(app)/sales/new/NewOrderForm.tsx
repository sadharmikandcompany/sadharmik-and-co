...
export function NewOrderForm({ nextMandirNumber, nextShopNumber, products, customers }: { nextMandirNumber?: number, nextShopNumber?: number, products: ProductOption[]; customers: CustomerOption[] }) {
