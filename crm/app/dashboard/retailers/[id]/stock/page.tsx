...
import { ArrowLeft, Package, TrendingUp, TrendingDown, DollarSign } from "lucide-react"
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <Button variant="ghost" onClick={() => router.push(`/dashboard/retailers/${retailerId}`)}>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {retailer.name} - {retailer.company_name || "Retailer"}
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Stock purchased by {retailer.name}
          </CardDescription>
        </CardHeader>
        <CardContent>
