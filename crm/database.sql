...
CREATE TABLE public.ap_invoices (
  ...
  CONSTRAINT ap_invoices_grn_id_fkey FOREIGN KEY (grn_id) REFERENCES public.goods_receipt_notes(id),
  CONSTRAINT ap_invoices_journal_id_fkey FOREIGN KEY (journal_id) REFERENCES public.journal_entries(id),
  CONSTRAINT ap_invoices_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id)
);
CREATE TABLE public.attendance (
  ...
  status USER-DEFINED DEFAULT 'absent'::attendance_status,
  notes text,
  total_hours numeric,
  created_by uuid,
  updated_by uuid,
...
CREATE TABLE public.bank_accounts (
  ...
  CONSTRAINT bank_accounts_coa_account_id_fkey FOREIGN KEY (coa_account_id) REFERENCES public.chart_of_accounts(id)
);
CREATE TABLE public.bank_transactions (
  ...
  CONSTRAINT bank_transactions_matched_journal_id_fkey FOREIGN KEY (matched_journal_id) REFERENCES public.journal_entries(id)
);
CREATE TABLE public.call_history (
  ...
  CONSTRAINT call_history_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id)
);
CREATE TABLE public.categories (
  ...
  CONSTRAINT fk_parent_category FOREIGN KEY (parent_category_id) REFERENCES public.categories(id)
);
...
CREATE TABLE public.courier_partner_pincodes (
  ...
  CONSTRAINT courier_partner_pincodes_courier_partner_id_fkey FOREIGN KEY (courier_partner_id) REFERENCES public.courier_partners(id)
);
...
CREATE TABLE public.daily_cash_reconciliation (
  ...
  total_cash_submitted numeric DEFAULT (((((((((notes_2000 * 2000) + (notes_500 * 500)) + (notes_200 * 200)) + (notes_100 * 100)) + (notes_50 * 50)) + (notes_20 * 20)) + (notes_10 * 10)))::numeric + coins_total),
  total_cash_expected numeric NOT NULL,
  cash_difference numeric DEFAULT (total_cash_expected - (((((((((notes_2000 * 2000) + (notes_500 * 500)) + (notes_200 * 200)) + (notes_100 * 100)) + (notes_50 * 50)) + (notes_20 * 20)) + (notes_10 * 10)))::numeric + coins_total)),
  ...
  CONSTRAINT daily_cash_reconciliation_delivery_partner_id_fkey FOREIGN KEY (delivery_partner_id) REFERENCES public.delivery_partners(id),
  CONSTRAINT daily_cash_reconciliation_reviewer_id_fkey FOREIGN KEY (reviewer_id) REFERENCES auth.users(id),
  CONSTRAINT daily_cash_reconciliation_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES auth.users(id)
);
CREATE TABLE public.debit_note_items (
  ...
  CONSTRAINT debit_note_items_debit_note_id_fkey FOREIGN KEY (debit_note_id) REFERENCES public.debit_notes(id)
);
...
CREATE TABLE public.delivery_partner_stock (
  ...
  CONSTRAINT delivery_partner_stock_route_assignment_id_fkey FOREIGN KEY (route_assignment_id) REFERENCES public.route_assignments(id),
  CONSTRAINT delivery_partner_stock_delivery_partner_id_fkey FOREIGN KEY (delivery_partner_id) REFERENCES public.delivery_partners(id),
  CONSTRAINT delivery_partner_stock_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id),
  CONSTRAINT delivery_partner_stock_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id),
  CONSTRAINT delivery_partner_stock_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id),
  CONSTRAINT delivery_partner_stock_source_godown_id_fkey FOREIGN KEY (source_godown_id) REFERENCES public.godowns(id)
);
CREATE TABLE public.delivery_partners (
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  serviceable_pincodes ARRAY DEFAULT '{}'::text[],
  mobile_secondary_1 text,
  mobile_secondary_2 text,
  flat_number text,
  floor_wing text,
  ...
  assigned_godown_ids ARRAY DEFAULT ARRAY[]::uuid[],
...
CREATE TABLE public.delivery_review_items (
  ...
  CONSTRAINT delivery_review_items_review_id_fkey FOREIGN KEY (review_id) REFERENCES public.delivery_reviews(id),
  CONSTRAINT delivery_review_items_route_assignment_id_fkey FOREIGN KEY (route_assignment_id) REFERENCES public.route_assignments(id),
  CONSTRAINT delivery_review_items_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id)
);
CREATE TABLE public.delivery_reviews (
  ...
  CONSTRAINT delivery_reviews_route_id_fkey FOREIGN KEY (route_id) REFERENCES public.routes(id),
  CONSTRAINT delivery_reviews_reviewer_id_fkey FOREIGN KEY (reviewer_id) REFERENCES auth.users(id),
...
CREATE TABLE public.delivery_sheets (
  ...
  order_ids ARRAY NOT NULL,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT delivery_sheets_pkey PRIMARY KEY (id),
  CONSTRAINT delivery_sheets_route_id_fkey FOREIGN KEY (route_id) REFERENCES public.routes(id),
  CONSTRAINT delivery_sheets_delivery_partner_id_fkey FOREIGN KEY (delivery_partner_id) REFERENCES public.delivery_partners(id)
);
CREATE TABLE public.distributors (
  ...
  CONSTRAINT distributors_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.distributors(id),
  CONSTRAINT distributors_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)
);
CREATE TABLE public.einvoice_items (
  ...
  CONSTRAINT einvoice_items_einvoice_id_fkey FOREIGN KEY (einvoice_id) REFERENCES public.einvoices(id)
);
CREATE TABLE public.einvoices (
  ...
  CONSTRAINT einvoices_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id),
  CONSTRAINT einvoices_purchase_id_fkey FOREIGN KEY (purchase_id) REFERENCES public.purchases(id)
);
CREATE TABLE public.ewaybills (
  ...
  CONSTRAINT ewaybills_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id),
  CONSTRAINT ewaybills_purchase_id_fkey FOREIGN KEY (purchase_id) REFERENCES public.purchases(id),
  CONSTRAINT ewaybills_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.users(id),
  CONSTRAINT ewaybills_einvoice_id_fkey FOREIGN KEY (einvoice_id) REFERENCES public.einvoices(id)
);
...
CREATE TABLE public.factory_warehouse_stock (
  ...
  CONSTRAINT factory_warehouse_stock_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id),
  CONSTRAINT factory_warehouse_stock_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id)
);
CREATE TABLE public.godown_stock (
  ...
  CONSTRAINT godown_stock_godown_id_fkey FOREIGN KEY (godown_id) REFERENCES public.godowns(id),
  CONSTRAINT godown_stock_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id)
);
CREATE TABLE public.godowns (
  ...
  CONSTRAINT godowns_distributor_id_fkey FOREIGN KEY (distributor_id) REFERENCES public.distributors(id),
  CONSTRAINT godowns_retailer_id_fkey FOREIGN KEY (retailer_id) REFERENCES public.retailers(id)
);
CREATE TABLE public.goods_receipt_notes (
  ...
  CONSTRAINT goods_receipt_notes_purchase_id_fkey FOREIGN KEY (purchase_id) REFERENCES public.purchases(id),
  CONSTRAINT goods_receipt_notes_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id),
  CONSTRAINT goods_receipt_notes_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.users(id)
);
CREATE TABLE public.grn_items (
  ...
  CONSTRAINT grn_items_variant_id_fkey FOREIGN KEY (variant_id) REFERENCES public.product_variants(id),
  CONSTRAINT grn_items_batch_id_fkey FOREIGN KEY (batch_id) REFERENCES public.stock_batches(id)
);
CREATE TABLE public.journal_entries (
  ...
  CONSTRAINT journal_entries_period_id_fkey FOREIGN KEY (period_id) REFERENCES public.accounting_periods(id)
);
CREATE TABLE public.journal_lines (
  ...
  CONSTRAINT journal_lines_journal_id_fkey FOREIGN KEY (journal_id) REFERENCES public.journal_entries(id),
...
CREATE TABLE public.loose_stock (
  ...
  CONSTRAINT loose_stock_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.product_categories(id)
);
CREATE TABLE public.loose_stock_transactions (
  ...
  CONSTRAINT loose_stock_transactions_purchase_id_fkey FOREIGN KEY (purchase_id) REFERENCES public.purchases(id),
  CONSTRAINT loose_stock_transactions_loose_stock_id_fkey FOREIGN KEY (loose_stock_id) REFERENCES public.loose_stock(id),
  CONSTRAINT loose_stock_transactions_vendor_id_fkey FOREIGN KEY (vendor_id) REFERENCES public.vendors(id),
  CONSTRAINT loose_stock_transactions_transferred_to_stock_id_fkey FOREIGN KEY (transferred_to_stock_id) REFERENCES public.stock_inventory(id)
);
CREATE TABLE public.myoperator_call_logs (
  ...
  CONSTRAINT myoperator_call_logs_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id)
);
...
CREATE TABLE public.myoperator_whatsapp_messages (
  ...
  CONSTRAINT myoperator_whatsapp_messages_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id)
);
CREATE TABLE public.order_change_requests (
  ...
  CONSTRAINT order_change_requests_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id),
  CONSTRAINT order_change_requests_assignment_id_fkey FOREIGN KEY (assignment_id) REFERENCES public.route_assignments(id),
  CONSTRAINT order_change_requests_delivery_partner_id_fkey FOREIGN KEY (delivery_partner_id) REFERENCES public.delivery_partners(id),
  CONSTRAINT order_change_requests_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.users(id)
);
...
CREATE TABLE public.orders (
  ...
  CONSTRAINT fk_distributor FOREIGN KEY (distributor_id) REFERENCES public.distributors(id),
  CONSTRAINT orders_retailer_id_fkey FOREIGN KEY (retailer_id) REFERENCES public.retailers(id),
  CONSTRAINT orders_delivery_partner_id_fkey FOREIGN KEY (delivery_partner_id) REFERENCES public.delivery_partners(id),
  CONSTRAINT orders_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES auth.users(id),
  CONSTRAINT orders_source_godown_id_fkey FOREIGN KEY (source_godown_id) REFERENCES public.godowns(id),
  CONSTRAINT orders_cancelled_by_fkey FOREIGN KEY (cancelled_by) REFERENCES public.users(id)
);
...
CREATE TABLE public.payment_outs (
  ...
  discount_percent numeric DEFAULT 0 CHECK (discount_percent >= 0::numeric AND discount_percent <= 100::numeric),
  final_amount numeric DEFAULT (paid_amount - ((paid_amount * discount_percent) / (100)::numeric)),
  image_proof_url text,
  payment_date timestamp with time zone NOT NULL DEFAULT now(),
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT payment_outs_pkey PRIMARY KEY (id),
  CONSTRAINT fk_payment_out_vendor FOREIGN KEY (vendor_id) REFERENCES public.vendors(id)
);
...
CREATE TABLE public.product_pincode_pricing (
  ...
  CONSTRAINT product_pincode_pricing_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id)
);
CREATE TABLE public.product_variants (
  ...
  CONSTRAINT product_variants_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.product_categories(id),
...
CREATE TABLE public.products (
  ...
  CONSTRAINT products_parent_category_id_fkey FOREIGN KEY (parent_category_id) REFERENCES public.categories(id),
  CONSTRAINT products_sub_category_id_fkey FOREIGN KEY (sub_category_id) REFERENCES public.categories(id),
  CONSTRAINT products_material_mapping_id_fkey FOREIGN KEY (material_mapping_id) REFERENCES public.variant_material_mapping(id)
);
CREATE TABLE public.purchase_items (
  ...
  CONSTRAINT fk_purchase FOREIGN KEY (purchase_id) REFERENCES public.purchases(id),
  CONSTRAINT fk_product_purchase FOREIGN KEY (product_id) REFERENCES public.products(id),
  CONSTRAINT purchase_items_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id)
);
CREATE TABLE public.purchases (
  ...
  remaining_amount numeric DEFAULT (total_amount - COALESCE(paid_amount, (0)::numeric)),
  batch_number text,
  CONSTRAINT purchases_pkey PRIMARY KEY (id),
  CONSTRAINT fk_purchase_distributor FOREIGN KEY (distributor_id) REFERENCES public.distributors(id),
  CONSTRAINT fk_purchase_vendor FOREIGN KEY (vendor_id) REFERENCES public.vendors(id)
);
CREATE TABLE public.reorder_rules (
  ...
  CONSTRAINT reorder_rules_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id),
  CONSTRAINT reorder_rules_variant_id_fkey FOREIGN KEY (variant_id) REFERENCES public.product_variants(id),
  CONSTRAINT reorder_rules_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES public.godowns(id)
);
CREATE TABLE public.retailers (
  ...
  CONSTRAINT retailers_distributor_id_fkey FOREIGN KEY (distributor_id) REFERENCES public.distributors(id),
  CONSTRAINT retailers_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)
);
CREATE TABLE public.route_assignments (
  ...
  CONSTRAINT fk_route FOREIGN KEY (route_id) REFERENCES public.routes(id),
  CONSTRAINT fk_order_assignment FOREIGN KEY (order_id) REFERENCES public.orders(id),
  CONSTRAINT fk_delivery_partner FOREIGN KEY (delivery_partner_id) REFERENCES public.delivery_partners(id)
);
CREATE TABLE public.routes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  route_name text NOT NULL,
  city text NOT NULL,
  pincodes ARRAY NOT NULL DEFAULT '{}'::text[] CHECK (array_length(pincodes, 1) > 0),
  description text,
  is_active boolean DEFAULT true,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
...
CREATE TABLE public.stock_batches (
  ...
  CONSTRAINT stock_batches_variant_id_fkey FOREIGN KEY (variant_id) REFERENCES public.product_variants(id),
  CONSTRAINT stock_batches_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES public.godowns(id)
);
CREATE TABLE public.stock_comments (
  ...
  CONSTRAINT stock_comments_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id),
  CONSTRAINT stock_comments_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id)
);
CREATE TABLE public.stock_dispatch_items (
  ...
  CONSTRAINT stock_dispatch_items_stock_dispatch_id_fkey FOREIGN KEY (stock_dispatch_id) REFERENCES public.stock_dispatches(id),
  CONSTRAINT stock_dispatch_items_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id)
);
CREATE TABLE public.stock_dispatches (
  ...
  CONSTRAINT stock_dispatches_to_godown_id_fkey FOREIGN KEY (to_godown_id) REFERENCES public.godowns(id)
);
CREATE TABLE public.stock_inventory (
  ...
  CONSTRAINT stock_inventory_variant_id_fkey FOREIGN KEY (variant_id) REFERENCES public.product_variants(id),
  CONSTRAINT stock_inventory_material_id_fkey FOREIGN KEY (material_id) REFERENCES public.packaging_materials(id),
  CONSTRAINT stock_inventory_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id)
);
CREATE TABLE public.stock_ledger (
  ...
  CONSTRAINT stock_ledger_warehouse_id_fkey FOREIGN KEY (warehouse_id) REFERENCES public.godowns(id),
...
CREATE TABLE public.stock_transfer_items (
  ...
  CONSTRAINT stock_transfer_items_stock_transfer_id_fkey FOREIGN KEY (stock_transfer_id) REFERENCES public.stock_transfers(id),
  CONSTRAINT stock_transfer_items_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id)
);
CREATE TABLE public.stock_transfers (
  ...
  CONSTRAINT stock_transfers_from_godown_id_fkey FOREIGN KEY (from_godown_id) REFERENCES public.godowns(id),
  CONSTRAINT stock_transfers_to_godown_id_fkey FOREIGN KEY (to_godown_id) REFERENCES public.godowns(id),
  CONSTRAINT stock_transfers_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id)
);
CREATE TABLE public.support_tickets (
  ...
  CONSTRAINT fk_ticket_customer FOREIGN KEY (customer_id) REFERENCES public.customers(id),
  CONSTRAINT fk_ticket_order FOREIGN KEY (order_id) REFERENCES public.orders(id)
);
...
CREATE TABLE public.ticket_messages (
  ...
  CONSTRAINT fk_message_ticket FOREIGN KEY (ticket_id) REFERENCES public.support_tickets(id)
);
CREATE TABLE public.user_agent_config (
  ...
  agent_modes ARRAY DEFAULT '{}'::text[],
  is_active boolean DEFAULT true,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  phone_name text,
  CONSTRAINT user_agent_config_pkey PRIMARY KEY (id),
  CONSTRAINT user_agent_config_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)
);
CREATE TABLE public.users (
  id uuid NOT NULL,
  email text NOT NULL UNIQUE,
  full_name text,
  role USER-DEFINED NOT NULL DEFAULT 'customer_support'::user_role,
  phone text,
  is_active boolean DEFAULT true,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  ...
  CONSTRAINT users_delivery_partner_id_fkey FOREIGN KEY (delivery_partner_id) REFERENCES public.delivery_partners(id)
);
CREATE TABLE public.variant_material_mapping (
  ...
  CONSTRAINT variant_material_mapping_variant_id_fkey FOREIGN KEY (variant_id) REFERENCES public.product_variants(id),
  CONSTRAINT variant_material_mapping_material_id_fkey FOREIGN KEY (material_id) REFERENCES public.packaging_materials(id),
  CONSTRAINT variant_material_mapping_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.products(id)
);
CREATE TABLE public.vendor_loose_stock (
  ...
  CONSTRAINT vendor_loose_stock_vendor_id_fkey FOREIGN KEY (vendor_id) REFERENCES public.vendors(id),
  CONSTRAINT vendor_loose_stock_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.product_categories(id)
);
CREATE TABLE public.vendor_stock (
  ...
  CONSTRAINT vendor_stock_vendor_id_fkey FOREIGN KEY (vendor_id) REFERENCES public.vendors(id),
  CONSTRAINT vendor_stock_stock_inventory_id_fkey FOREIGN KEY (stock_inventory_id) REFERENCES public.stock_inventory(id)
);
CREATE TABLE public.vendors (
  ...
  CONSTRAINT vendors_distributor_id_fkey FOREIGN KEY (distributor_id) REFERENCES public.distributors(id)
);